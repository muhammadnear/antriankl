...
<html lang="en">
			   		...
			   		<div class="col-twelve">
							...
							?>
								<div style="margin: auto; padding: 2%;">
									...
									<center>
										<p class="bg-warning" style="text-align:left; padding:15px; font-family: sans-serif;">&emsp;<b>Catatan</b>: <br>
										1. Pemohon Wajib mengisi Data
										    diri yang benar;<br>
										2. Pemohon wajib membawa  
										    persyaratan yang ditentukan;<br>
										3. Pemohon wajib menunjukan 
										    bukti booking antrian online;<br>
										4. Pemohon wajib datang sesuai 
										    Jadwal minimal 15 menit 
										    sebelum jam yang dipilih;<br>
										5. Pemohon tidak akan dilayani 
										    apabila lewat tanggal maupun 
										    jam yang telah ditentukan;<br>
										6. Pemohon tidak akan dilayani   
										    apabila tidak memenuhi  
										    persyaratan yang ditentukan<br></p>
									</center>
						    ...
						    <div class="row setup-content" id="step-1">
						        <div class="col-md-12" style="margin: auto; width: 100%;">
						          ...
						          <div class="form-group">
						            ...
						            <input id="no_hape" maxlength="100" name="no_hp" type="number" style="color: rgb(200,200,200);" required="required" class="form-control" placeholder="Contoh: 601XXXXXX" />
						          </div>
						          <div class="form-group">
						            <label class="control-label" style="color: rgb(180,180,180);">Email</label>
						            <input maxlength="100" id="email" name="email" type="email" style="color: rgb(200,200,200);" required="required" class="form-control" placeholder="Masukkan Email" />
						          </div>
						          <div class="form-group">
						            <label class="control-label" style="color: rgb(180,180,180);">No Paspor / Working Permit</label>
						            <input maxlength="100" name="no_paspor" type="text" style="color: rgb(200,200,200);" required="required" class="form-control" placeholder="Contoh: X354313" />
						          </div>
						          <div>
						          ...
						          <div id="error-step-1">
						          	<center><p class='bg-danger' style='padding:15px; font-family: sans-serif;'>Mohon isi semua atribut dengan benar dan centang pernyataan diatas.</p></center>
						          </div>
						          <div id="error-step-15">
						          	<center><p class='bg-danger' style='padding:15px; font-family: sans-serif;'>Format email anda salah.</p></center>
						          </div>						          
						    ...
						    <div class="row setup-content" id="step-2">
						        <div class="col-md-12" style="margin: auto; width: 100%;">
						          ...
						          <div class="form-group">
									...
									<div id="div_rotate" style="margin-top: 30px;">
			...
			<section id="features">
				...
				<div class="row section-intro group animate-this">	
			   		<div class="col-twelve with-bottom-line">
			   			...
			   			<h2 class="">Persyaratan Pembuatan Paspor di KBRI KL</h2>
			   			
			   		</div>   		
			   	</div>
			   	<div class="row features-wrap">
						<p style="color: red; text-align: left; font-family: 'roboto-medium'; margin-left: 30px;">CATATAN :<br>
			   			1. Pemohon wajib membawa dokumen asli dan fotokopi dari setiap persyaratan yg diminta.<br>
			   			2. Pemohon wajib menulis alamat tempat tinggal secara lengkap.<br></p>		     		
							...
							<div class="bgrid feature animate-this">	
							   ...
							   <div class="feature-content">
									...
									<p> 1.	Paspor ayah atau ibu;<br>
										...
										4.	Akte Lahir;<br>
										5.	Surat Kenal Lahir dari Konsuler (jika anak lahir di Malaysia)<br>
							...
							<div class="bgrid feature animate-this">	
							   ...
							   <div class="feature-content">
									...
									<p> 1.	Paspor lama;<br>
										...
										5.	Akte Lahir;<br>
										6.	Surat Kenal Lahir dari Konsuler (jika anak lahir di Malaysia)<br>
										7.	Surat pengangkatan anak (jika pemohon adalah anak angkat)<br>
			...
			<section id="download">
			   	...
			   	<div class="row download-content" >
			   		<div class="col-twelve">
					   	...
					   	<a class="button large animate-this" href="https://play.google.com/store/apps/details?id=net.jonero.klonlinequeue&hl=in">
					         Download apk
					      </a>  			
	...
	<script type="text/javascript">
		...
		function rotateFunc()
		{
		    ...
		    var substract = $("#image").width() - $("#image").height();
		    if((angle%360==270 || angle%360==90))
		    {
		    	if(substract > 30)
		    		$("#div_rotate").css('margin-top', (30+(substract/2))+"px");
			}
		    else
		    	$("#div_rotate").css('margin-top', "30px");
		}
		  ...
		  allNextBtn.click(function(){
			  ...
			  if(curStep.attr("id") == "step-1")
			  {
			  	 if(!($('#chck_1').is(":checked")))
  			  	 ...
  			  	 {
				    isValid = false;
  					$("#error-step-15").fadeIn("slow");
  				 	$("#error-step-15").fadeOut(3000);
				 }
  		  	  }
