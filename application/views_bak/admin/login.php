...
<body style="background-color:#f1f2f7">
	<div class="container">
  		<p class="text-center"> <img src="<?php echo base_url() ?>assets/img/logo.png" style="width:auto; height:250px;"> </p>
      ...
      <center>@Copyright 2017. <span>Nama PT. Umrah</span>, V.0.0.1</center>
      <?php 
          if($error)
