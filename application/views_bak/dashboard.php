			   		...
			   		<div class="col-twelve">
							...
							?>
								<div style="margin: auto; padding: 2%;">
									...
									<center><p class='bg-warning' style='padding:15px; font-family: sans-serif;'> Perhatian : Nomor antrian ini akan <b>gugur</b> jika data yang dimasukkan pemohon tidak sesuai.</p></center>
					  	...
					  	<form id="form_" enctype="multipart/form-data" role="form" action="<?php echo base_url()?>index.php/page/register" method="post">
